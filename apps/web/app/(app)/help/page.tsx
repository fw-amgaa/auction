...
const FAQS: [string, string][] = [
  ...
  ["Дуудлага хэзээ дуусах вэ?", "Дуудлага худалдаа захиргааны товлосон хугацаанд яг таг явагдана. Тоолуур тэглэхэд дуудлага хаагдаж, хамгийн өндөр санал хожно — хугацаа сунгагдахгүй."],
